/*
 * Получает данные с барометра BMP580 с интервалом BAROMETR_UPDATE_INTERVAL.
...
#define BAROMETR_UPDATE_INTERVAL 1.0 // С каким интервалом обновлять показания
 ...
 * с интервалом BAROMETR_UPDATE_INTERVAL и сохраняет их в barometrData.
 */
void loopBarometr()
{
    static double lastUpdateTime = 0.0;
    if (t - lastUpdateTime >= BAROMETR_UPDATE_INTERVAL)
    {
        uint8_t data[6];
